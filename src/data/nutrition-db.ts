...
export const NUTRITION_DB: Record<string, Macro> = {
  ...
  // ===== Mocktail syrups and sugars (per 100ml or 100g) =====
  'simple syrup': { calories: 290, protein: 0, carbs: 72, fat: 0 },
  'sugar syrup': { calories: 290, protein: 0, carbs: 72, fat: 0 },
  'gomme syrup': { calories: 290, protein: 0, carbs: 72, fat: 0 },
  'grenadine': { calories: 268, protein: 0, carbs: 67, fat: 0 },
  'agave syrup': { calories: 310, protein: 0, carbs: 76, fat: 0.5 },
  'agave nectar': { calories: 310, protein: 0, carbs: 76, fat: 0.5 },
  'powdered sugar': { calories: 389, protein: 0, carbs: 100, fat: 0 },
  'caster sugar': { calories: 387, protein: 0, carbs: 100, fat: 0 },

  // ===== Cocktail juices (per 100ml) =====
  ...
  'pineapple juice': { calories: 53, protein: 0.4, carbs: 12.9, fat: 0.1 },
  'cranberry juice': { calories: 46, protein: 0.4, carbs: 12, fat: 0.1 },
  'grapefruit juice': { calories: 39, protein: 0.5, carbs: 9.2, fat: 0.1 },
  'apple juice': { calories: 46, protein: 0.1, carbs: 11.3, fat: 0.1 },
  'grape juice': { calories: 60, protein: 0.4, carbs: 14.8, fat: 0.1 },
  'tomato juice': { calories: 17, protein: 0.8, carbs: 4.2, fat: 0.1 },

  // ===== Sodas and mixers (per 100ml) =====
  'soda water': { calories: 0, protein: 0, carbs: 0, fat: 0 },
  'carbonated water': { calories: 0, protein: 0, carbs: 0, fat: 0 },
  'tonic water': { calories: 34, protein: 0, carbs: 9, fat: 0 },
  'club soda': { calories: 0, protein: 0, carbs: 0, fat: 0 },
  'ginger ale': { calories: 35, protein: 0, carbs: 9, fat: 0 },
  'ginger beer': { calories: 50, protein: 0, carbs: 12, fat: 0 },
  'coca-cola': { calories: 42, protein: 0, carbs: 10.6, fat: 0 },
  'cola': { calories: 42, protein: 0, carbs: 10.6, fat: 0 },
  'sprite': { calories: 38, protein: 0, carbs: 9.4, fat: 0 },
  '7-up': { calories: 38, protein: 0, carbs: 9.4, fat: 0 },
  'lemonade': { calories: 40, protein: 0.1, carbs: 10, fat: 0 },
  'energy drink': { calories: 45, protein: 0, carbs: 11, fat: 0 },

  // ===== Cocktail dairy and creams (per 100ml or 100g) =====
  'light cream': { calories: 195, protein: 2.7, carbs: 4, fat: 19 },
  'whipped cream': { calories: 257, protein: 3.2, carbs: 3.5, fat: 22.2 },
  'coconut cream': { calories: 330, protein: 3.6, carbs: 6.7, fat: 35 },
  'condensed milk': { calories: 321, protein: 7.9, carbs: 54, fat: 8.7 },
  'half and half': { calories: 130, protein: 3, carbs: 4.3, fat: 11.5 },

  // ===== Other common cocktail extras =====
  'coffee': { calories: 1, protein: 0.1, carbs: 0, fat: 0 },
  'espresso': { calories: 9, protein: 0.1, carbs: 1.7, fat: 0.2 },
  'tea': { calories: 1, protein: 0.1, carbs: 0.3, fat: 0 },
  'egg white': { calories: 52, protein: 11, carbs: 0.7, fat: 0.2 },
  'maraschino cherry': { calories: 165, protein: 0.4, carbs: 41, fat: 0.2 },
  'cherry': { calories: 50, protein: 1, carbs: 12, fat: 0.3 },
  'lemon peel': { calories: 47, protein: 1.5, carbs: 16, fat: 0.3 },
  'orange peel': { calories: 97, protein: 1.5, carbs: 25, fat: 0.2 },
