...
export const NUTRITION_DB: Record<string, Macro> = {
  ...
  // ===== Cocktail spirits and liqueurs (per 100ml) =====
  // Calories from alcohol: 7 kcal per gram. Values per 100ml using USDA
  // averages. Liqueurs add sugar so carbs are higher.
  'vodka': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  'gin': { calories: 263, protein: 0, carbs: 0, fat: 0 },
  'light rum': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  'dark rum': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  '151 proof rum': { calories: 339, protein: 0, carbs: 0, fat: 0 },
  'rum': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  'tequila': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  'mezcal': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  'whiskey': { calories: 250, protein: 0, carbs: 0, fat: 0 },
  'whisky': { calories: 250, protein: 0, carbs: 0, fat: 0 },
  'scotch': { calories: 250, protein: 0, carbs: 0, fat: 0 },
  'bourbon': { calories: 250, protein: 0, carbs: 0, fat: 0 },
  'rye whiskey': { calories: 250, protein: 0, carbs: 0, fat: 0 },
  'brandy': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  'cognac': { calories: 231, protein: 0, carbs: 0, fat: 0 },
  'champagne': { calories: 80, protein: 0.1, carbs: 1.8, fat: 0 },
  'prosecco': { calories: 80, protein: 0.1, carbs: 1.8, fat: 0 },
  'sparkling wine': { calories: 80, protein: 0.1, carbs: 1.8, fat: 0 },
  'red wine': { calories: 85, protein: 0.1, carbs: 2.6, fat: 0 },
  'white wine': { calories: 82, protein: 0.1, carbs: 2.6, fat: 0 },
  'dry vermouth': { calories: 105, protein: 0.1, carbs: 4, fat: 0 },
  'sweet vermouth': { calories: 158, protein: 0, carbs: 16, fat: 0 },
  'vermouth': { calories: 130, protein: 0.1, carbs: 10, fat: 0 },
  'triple sec': { calories: 250, protein: 0, carbs: 25, fat: 0 },
  'cointreau': { calories: 311, protein: 0, carbs: 28, fat: 0 },
  'grand marnier': { calories: 261, protein: 0, carbs: 25, fat: 0 },
  'amaretto': { calories: 282, protein: 0, carbs: 35, fat: 0 },
  'kahlua': { calories: 336, protein: 0, carbs: 38, fat: 0 },
  'baileys irish cream': { calories: 327, protein: 3, carbs: 25, fat: 13 },
  'baileys': { calories: 327, protein: 3, carbs: 25, fat: 13 },
  'campari': { calories: 233, protein: 0, carbs: 24, fat: 0 },
  'aperol': { calories: 217, protein: 0, carbs: 22, fat: 0 },
  'maraschino liqueur': { calories: 270, protein: 0, carbs: 28, fat: 0 },
  'chambord': { calories: 280, protein: 0, carbs: 32, fat: 0 },
  'sambuca': { calories: 245, protein: 0, carbs: 30, fat: 0 },
  'creme de cacao': { calories: 310, protein: 0, carbs: 33, fat: 0 },
  'creme de menthe': { calories: 354, protein: 0, carbs: 41, fat: 0 },
  'creme de cassis': { calories: 280, protein: 0, carbs: 35, fat: 0 },
  'apricot brandy': { calories: 270, protein: 0, carbs: 25, fat: 0 },
  'peach schnapps': { calories: 264, protein: 0, carbs: 30, fat: 0 },
  'midori': { calories: 248, protein: 0, carbs: 35, fat: 0 },
  'jaegermeister': { calories: 247, protein: 0, carbs: 12, fat: 0 },
  'fernet branca': { calories: 211, protein: 0, carbs: 0, fat: 0 },
  'pisco': { calories: 248, protein: 0, carbs: 0, fat: 0 },
  'absinthe': { calories: 348, protein: 0, carbs: 0, fat: 0 },
  'sake': { calories: 134, protein: 0.5, carbs: 5, fat: 0 },
  'soju': { calories: 168, protein: 0, carbs: 0, fat: 0 },
  'cachaca': { calories: 231, protein: 0, carbs: 0, fat: 0 },

  // ===== Bitters and small dashes =====
  // Used by the dash; per 100ml values are theoretical only.
  'angostura bitters': { calories: 233, protein: 0, carbs: 50, fat: 0 },
  'bitters': { calories: 233, protein: 0, carbs: 50, fat: 0 },
  'orange bitters': { calories: 233, protein: 0, carbs: 50, fat: 0 },

  // ===== Cocktail syrups and sugars (per 100ml or 100g) =====
